...
public class JLayerActivity extends Activity {
    ...
    private static final String TAG = "JLayerActivity";

    private Decoder mDecoder;
    private AudioTrack mAudioTrack;
    // 放置mp3的位置,根据音频文件的大小，这里需要注意解密的时间也不同，在放置导盲犬xiaoQ的音乐时，要等一会，而一般的音乐可以进行即时播放
    private File oldFile = new File(Environment.getExternalStorageDirectory().getPath(), "q.mp3");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "Buffer Size and sample rate, Size :" + size + " & Rate: " + rate);
